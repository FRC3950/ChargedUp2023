...
public class TeleopIntakeOutCommandGroup extends SequentialCommandGroup {
  /** Creates a new RestMode_CommandGroup. */
  public TeleopIntakeOutCommandGroup(Wrist wrist, Arm arm, Telescope telescope, Intake intake) {
    addCommands(
      //1. 
